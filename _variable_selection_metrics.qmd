...
For our purposes, we will use SHAP values for variable selection. I decided to use a random forest so we can compare the results to the results from the MDI method.
